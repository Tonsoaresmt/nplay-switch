...
const routes = [
  ...
  ['Perfil', '/api/account/profiles', 'account', 'post', '/profiles'],
  ['Perfil', '/api/account/profiles/%d', 'account', 'patch', '/profiles/:id'],
  ['Perfil', '/api/account/profiles/%d', 'account', 'delete', '/profiles/:id'],
  ['Perfil', '/api/account/avatars', 'account', 'get', '/avatars'],
  ['Conta', '/api/account/password', 'account', 'patch', '/password'],
  ['Conta', '/api/account/email', 'account', 'patch', '/email'],
